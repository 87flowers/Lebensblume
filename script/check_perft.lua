local reference_engine = {"./stoat-0.1.19-native"}
local reference_engine_perft_cmd = "splitperft"
local dev_engine = {"./lebensblume"}
...
drillIntoPerft("l6nl/5+P1gk/2np1S3/p1p4Pp/3P2Sp1/1PPb2P1P/P5GS1/R2g2K2/LN4b1L w RGsn5p 3", 4)
